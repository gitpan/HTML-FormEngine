# This Makefile is for the HTML::FormEngine extension to perl.
#
...
#     NAME => q[HTML::FormEngine]
#     PREREQ_PM => { Date::Pcalc=>q[1.2], Hash::Merge=>q[0.07], Clone=>q[0.13], Locale::gettext=>q[1.01] }
#     VERSION_FROM => q[FormEngine.pm]
...
DISTNAME = HTML-FormEngine
NAME_SYM = HTML_FormEngine
VERSION = 0.7.3
VERSION_SYM = 0_7_3
XS_VERSION = 0.7.3
...
FULLEXT = HTML/FormEngine
BASEEXT = FormEngine
PARENT_NAME = HTML
DLBASE = $(BASEEXT)
VERSION_FROM = FormEngine.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
H_FILES = 
MAN1PODS = 
MAN3PODS = FormEngine.pm \
	FormEngine/Checks.pm \
	FormEngine/Handler.pm \
	FormEngine/Skin.pm
...
TO_INST_PM = FormEngine.pm \
	FormEngine/Checks.pm \
	FormEngine/Config.pm \
	FormEngine/Handler.pm \
	FormEngine/Skin.pm

PM_TO_BLIB = FormEngine/Checks.pm \
	...
	FormEngine/Config.pm \
	blib/lib/HTML/FormEngine/Config.pm \
	FormEngine/Handler.pm \
...
manifypods : pure_all FormEngine/Checks.pm \
	FormEngine.pm \
	FormEngine/Skin.pm \
	FormEngine/Handler.pm
	@$(POD2MAN) \
	FormEngine/Checks.pm \
	$(INST_MAN3DIR)/HTML::FormEngine::Checks.$(MAN3EXT) \
	FormEngine.pm \
	$(INST_MAN3DIR)/HTML::FormEngine.$(MAN3EXT) \
	FormEngine/Skin.pm \
	$(INST_MAN3DIR)/HTML::FormEngine::Skin.$(MAN3EXT) \
	FormEngine/Handler.pm \
	$(INST_MAN3DIR)/HTML::FormEngine::Handler.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -rf $(DISTVNAME)
	rm -f  blib/lib/HTML/FormEngine/Checks.pm blib/lib/HTML/FormEngine.pm
	rm -f blib/lib/HTML/FormEngine/Skin.pm blib/lib/HTML/FormEngine/Config.pm
	rm -f blib/lib/HTML/FormEngine/Handler.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"0,7,3,0\">\n\t<TITLE>$(DISTNAME)</TITLE>\n\t<ABSTRACT></ABSTRACT>\n\t<AUTHOR></AUTHOR>\n}" > $(DISTNAME).ppd
	@$(PERL) -e "print qq{\t<IMPLEMENTATION>\n\t\t<DEPENDENCY NAME=\"Clone\" VERSION=\"0,13,0,0\" />\n\t\t<DEPENDENCY NAME=\"Date-Pcalc\" VERSION=\"1,2,0,0\" />\n\t\t<DEPENDENCY NAME=\"Hash-Merge\" VERSION=\"0,07,0,0\" />\n\t\t<DEPENDENCY NAME=\"Locale-gettext\" VERSION=\"1,01,0,0\" />\n}" >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{FormEngine/Checks.pm blib/lib/HTML/FormEngine/Checks.pm FormEngine.pm blib/lib/HTML/FormEngine.pm FormEngine/Skin.pm blib/lib/HTML/FormEngine/Skin.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(PERLRUNINST) "-MExtUtils::Install" \
	-e "pm_to_blib({qw{FormEngine/Config.pm blib/lib/HTML/FormEngine/Config.pm FormEngine/Handler.pm blib/lib/HTML/FormEngine/Handler.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
